...
<head>
    ...
    <title>Update Admin | SIMBAT</title>
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left" method="post" action="../../pilihadmin/do_ubahdataadmin">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="inputNRP" class="form-control col-md-7 col-xs-12" data-validate-length-range="1,10" id="inputNRP" placeholder="" 
                                        value="<?php echo $NRP; ?>" name="inputNRP" required="required" readonly="readonly" onfocus="checkNull('inputNoHP', 'confirmMessage2', 'inputNoHP'); return false;"
        ...
        function checkNull($before, $msgBefore, $typeBefore){
            ...
            if (elem.value == ""){
                ...
                if ($typeBefore == "inputNama"){
                    ...
                    message.innerHTML = "NRP tidak boleh kosong!"    
                }
